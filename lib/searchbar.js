...
SearchEngines.on("defaults.added", setAllEnginePlaceholders);
SearchEngines.on("defaults.sorted", setAllEnginePlaceholders);
SearchEngines.on("defaults.removed", setAllEnginePlaceholders);
