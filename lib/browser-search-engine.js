...
const _BrowserSearchEngines = EventEmitter.compose({
...
const SearchEngine = Trait.compose({
  ...
  constructor: function SearchEngine(nsISearchEngine) {
    // we accept name, alias, or an nsISearchEngine object
    if (typeof nsISearchEngine == "string") {
      this._engine = BrowserSearchEngines.get(nsISearchEngine);
    } else {
...
var BrowserSearchEngines = exports.BrowserSearchEngines = new _BrowserSearchEngines();
