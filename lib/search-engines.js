...
var Trait = require('traits').Trait,
    ...
    defer = require('api-utils/promise').defer,
...
var SearchSuggestManager = EventEmitter.compose({
  ...
  _set_engines : function _set_engines() {
    this._engines = SearchEngines.defaults.all.filter(function (engine) {
