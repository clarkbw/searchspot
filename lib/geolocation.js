...
// simpleprefs doesn't seem to work in Thunderbird, pretty sure that's not true though
...
const Geolocation = EventEmitter.compose({
  ...
  get allowed() true, /*simpleprefs.prefs[ALLOW_GEOLOCATION_PREF],*/
  set allowed(allow) allow = true, /*simpleprefs.prefs[ALLOW_GEOLOCATION_PREF] = allow,*/
