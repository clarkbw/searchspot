...
const SearchEnginesPreferences = EventEmitter.compose({
  ...
  _targets : [ "defaults.added", "defaults.removed", "others.added", "others.removed" ],
  _targetListeners : {},
  ...
  _onAttach : function _onAttach(worker) {
    ...
    worker.port.emit("preferences", { "stats" : StatisticsReporter.allowed, "collect" : SearchEnginesCollector.allowed });
